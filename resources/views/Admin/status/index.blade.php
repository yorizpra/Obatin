               ...
               <div class="row">
                   <div class="col-md-14">
                       ...
                       <div class="card">
                           ...
                           <div class="card-action">
                                <a href="{{url('/admin/status-pemesanan/add')}}" class="btn btn-danger"><i class="fa fa-plus p-r-5">  Tambah Status Pemesanan</i></a>
                           </div>
                    ...
                    <tbody>
                        @foreach($status as $s)
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/status-pemesanan/edit/{{ $s->id }}" class="btn btn-warning">Edit</a>
                                    <a href="/admin/status-pemesanan/delete/{{ $s->id }}" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
