                   ...
                   <div class="col-md-12">
                       ...
                       <div class="card">
                           <div class="card-action">
                                <form role="form" method="post" action="{{ url('/admin/status-pembayaran/store/'. $statusbayar->id) }}">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" name="nama_status" class="form-control" placeholder="Nama Status" value="{{$statusbayar->nama_status}}" >
