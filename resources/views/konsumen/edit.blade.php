...
<body>
		...
		<div id="sideNav" href=""><i class="material-icons dp50">toc</i></div>
            ...
            <ul class="nav navbar-top-links navbar-right">
                 ...
                 <li><a class="drop-down" data-toggle="drop-down" ><i class="fa fa-user fa-fw"></i>{{ Auth::guard('admin')->user()->name }}<span class="caret"></span></a>
                   ...
                   <div class="col-md-9">
                       ...
                       <div class="card">
                           <div class="card-action">
                                <form role="form" method="post" action="{{ url('/konsumen/update/'. $konsumen->id) }}">
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="box-body">
                                <div class="form-group">

                                        <input type="text" name="name" class="form-control" placeholder="Nama Kunsumen" value="{{$konsumen->name}}">
                                        @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" name="email" class="form-control" placeholder="E-mail" value="{{$konsumen->email}}" >
                                        @if($errors->has('email'))
                                            <div class="text-danger">
                                                {{ $errors->first('email')}}
                                            </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_lahir" class="form-control" placeholder="tanggal lahir" value="{{$konsumen->tanggal_lahir}}">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" name="noHp" class="form-control" placeholder="Ho. Handphone" value="{{$konsumen->noHp}}">
                                        @if($errors->has('noHp'))
                                            <div class="text-danger">
                                                {{ $errors->first('noHp')}}
                                            </div>
